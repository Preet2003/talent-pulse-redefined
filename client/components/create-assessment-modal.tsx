...
import { CreateAssessmentManualModal } from "./create-assessment-manual-modal"
import { CreateAssessmentAIModal } from "./create-assessment-ai-modal"
...
export function CreateAssessmentModal({ open, onOpenChange }: CreateAssessmentModalProps) {
  ...
  return (
    <>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          "Import from question libraries",
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          "Automatic scoring and evaluation criteria",
                        ].map((feature, index) => (
                          <div
                            key={index}
                            className="flex items-center space-x-3 transform transition-all duration-200"
      ...
      <CreateAssessmentManualModal open={showManualModal} onOpenChange={setShowManualModal} />

      <CreateAssessmentAIModal open={showAIModal} onOpenChange={setShowAIModal} />
    </>
  )
}
