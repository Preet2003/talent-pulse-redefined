...
import { Check, Sparkles, Edit3, ArrowRight } from "lucide-react"
import { CreateLibraryManualModal } from "./create-library-manual-modal"
...
export function CreateLibraryModal({ open, onOpenChange, onLibraryCreated }: CreateLibraryModalProps) {
  ...
  const handleContinue = () => {
    if (selectedOption === "manual") {
      ...
      console.log("AI creation not implemented yet")
    }
  }
          ...
          <div className="p-8">
            <DialogHeader className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg">
                Choose how you'd like to build your question library
              </p>
            </DialogHeader>
                  ...
                  <div className="flex items-start space-x-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        Build your question library step by step with complete control over questions, categories, and
                        structure.
                      </p>
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          "Question by question management",
                          "Custom skill area organization",
                        ].map((feature, index) => (
                          <div
                            key={index}
                ...
                >
                  <div className="flex items-start space-x-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        Let AI create a comprehensive question library based on your domain and requirements.
                      </p>

                      {/* Features */}
                      <div className="space-y-3">
                        {[
                          "Smart question generation by topic",
            ...
            <div className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <Button
                ...
                disabled={selectedOption === "ai"}
                className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-600/25 transition-all duration-200 hover:shadow-xl hover:shadow-blue-600/30 group disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <span>Continue</span>
